...
class PaymentScheduleTest : KSRobolectricTestCase() {
    ...
    private val samplePaymentIncrements = listOf(
        PaymentIncrement(
            amount = Money.builder().amount("3400").build(),
        ...
        PaymentIncrement(
            amount = Money.builder().amount("2500").build(),
        ...
        PaymentIncrement(
            amount = Money.builder().amount("4500").build(),
            state = State.UNATTEMPTED,
        ...
        PaymentIncrement(
            amount = Money.builder().amount("5200").build(),
            state = State.COLLECTED,
