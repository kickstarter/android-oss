...
class DeprecatedCommentsActivity : BaseActivity<DeprecatedCommentsViewModel.ViewModel>(), DeprecatedCommentsAdapter.Delegate {
    private val adapter = DeprecatedCommentsAdapter(this)
