...
class LakeTest : KSRobolectricTestCase() {
    ...
    private fun assertProjectProperties(project: Project) {
        ...
        assertEquals(project.deadline()?.toDate()?.time, expectedProperties["project_deadline"])
        ...
        assertEquals(project.launchedAt()?.toDate()?.time, expectedProperties["project_launched_at"])
