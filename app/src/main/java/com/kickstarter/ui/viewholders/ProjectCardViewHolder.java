...
public final class ProjectCardViewHolder extends KSViewHolder {
  ...
  protected @BindView(R.id.deadline_countdown) TextView deadlineCountdownTextView;
  protected @BindView(R.id.deadline_countdown_unit) TextView deadlineCountdownUnitTextView;
  ...
  protected @BindView(R.id.friend_backing_avatar) ImageView friendBackingAvatarImageView;
  protected @BindView(R.id.friend_backing_message) TextView friendBackingMessageTextView;
  protected @BindView(R.id.friend_backing_group) ViewGroup friendBackingViewGroup;
  protected @BindView(R.id.funding_successful_date_text_view) TextView fundingSuccessfulTextViewDate;
  protected @BindView(R.id.funding_unsuccessful_view_group) ViewGroup fundingUnsuccessfulViewGroup;
  protected @BindView(R.id.funding_successful_view_group) ViewGroup fundingSuccessfulViewGroup;
  protected @BindView(R.id.funding_unsuccessful_text_view) TextView fundingUnsuccessfulTextView;
  protected @BindView(R.id.funding_unsuccessful_date_text_view) TextView fundingUnsuccessfulTextViewDate;
  protected @Nullable @BindView(R.id.land_card_view_group) ViewGroup landCardViewGroup;
  protected @BindView(R.id.name_and_blurb_text_view) TextView nameAndBlurbTextView;
  protected @BindView(R.id.percent) TextView percentTextView;
  ...
  protected @BindView(R.id.project_card_view_group) ViewGroup projectCardViewGroup;
  protected @BindView(R.id.project_card_stats_view_group) ViewGroup projectCardStatsViewGroup;
  ...
  protected @BindView(R.id.saved_view_group) ViewGroup savedViewGroup;
