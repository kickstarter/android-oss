...
public class BooleanPreference {
  ...
  public BooleanPreference(final SharedPreferences sharedPreferences, final String key) {
    this(sharedPreferences, key, false);
  }

  public BooleanPreference(final SharedPreferences sharedPreferences, final String key, final boolean defaultValue) {
