...
class PledgeFragmentLegacyViewModelTest :
        ...
        stripe?.onSetupResult(
            ...
            object : ApiResultCallback<SetupIntentResult> {
                override fun onSuccess(result: SetupIntentResult) {
                    this@PledgeFragmentLegacyViewModelTest.viewModel.inputs.stripeSetupResultSuccessful(result.outcome)
                }

                override fun onError(e: Exception) {
                    this@PledgeFragmentLegacyViewModelTest.viewModel.inputs.stripeSetupResultUnsuccessful(e)
                }
            }
        )
    }
        ...
        for (urlSpan in urlSpans) {
            val clickableSpan = object : ClickableSpan() {
                override fun onClick(widget: View) {
                    this@PledgeFragmentLegacyViewModelTest.viewModel.inputs.linkClicked(urlSpan.url)
                }
