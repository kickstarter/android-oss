...
fun rewardTransformer(
    ...
    val isFeatured = rewardGr.featured ?: false
...
fun backingTransformer(backingGr: com.kickstarter.fragment.Backing?): Backing {
    ...
    val paymentIncrements = backingGr?.paymentIncrements?.map {
        val paymentIncrementAmount = PaymentIncrementAmount.builder()
            ...
            .build()
        val paymentIncrementBadge = it.paymentIncrement.badge?.let {
            PaymentIncrementBadge.builder()
                .copy(it.paymentIncrementBadge.copy)
                .variant(getPaymentIncrementBadgeVariantType(badgeVariant = it.paymentIncrementBadge.variant))
                .build()
        }
