...
public interface CommentsViewModel {
  ...
  final class ViewModel extends ActivityViewModel<CommentsActivity> implements Inputs, Outputs {
    ...
    private @NonNull
    Observable<Comment> postComment(final @NonNull Either<Project, Update> projectOrUpdate, final @NonNull String body) {
    ...
    @Override
    public void commentBodyChanged(final @NonNull String string) {
