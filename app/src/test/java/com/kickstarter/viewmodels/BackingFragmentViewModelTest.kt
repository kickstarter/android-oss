...
class BackingFragmentViewModelTest :  KSRobolectricTestCase() {
    ...
    private val projectAndReward = TestSubscriber.create<Pair<ProjectTracking, Reward>>()
    ...
    fun testBackerAvatar() {
        ...
        this.vm.inputs.project(ProjectTrackingFactory.project(ProjectFactory.backedProject()))
    ...
    fun testProjectAndReward() {
        ...
        val projectTracking = ProjectTrackingFactory.project(backedProject)
        this.vm.inputs.project(projectTracking)
        this.projectAndReward.assertValue(Pair(projectTracking, reward))
    }
