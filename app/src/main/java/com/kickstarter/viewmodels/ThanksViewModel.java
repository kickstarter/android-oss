...
public interface ThanksViewModel {
    ...
    final class ViewModel extends ActivityViewModel<ThanksActivity> implements Inputs, Outputs {
        ...
        Observable<Category> rootCategory(final @NonNull Project project, final @NonNull ApiClientType client) {
         ...
         */
        private @NonNull
        Observable<List<Project>> relatedProjects(final @NonNull Project project, final @NonNull ApiClientType client) {
