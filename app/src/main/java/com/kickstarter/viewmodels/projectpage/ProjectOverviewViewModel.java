...
public interface ProjectOverviewViewModel {
    ...
    interface Outputs {
        ...
        KSString getKSString();
    }

    final class ViewModel extends FragmentViewModel<ProjectOverviewFragment> implements Inputs, Outputs {
        ...
        public ViewModel(final @NonNull Environment environment) {
            ...
            this.projectStateViewGroupBackgroundColorInt = project
                    .filter(p -> !p.isLive())
                    .map(p -> p.state().equals(Project.STATE_SUCCESSFUL) ? R.color.green_alpha_50 : R.color.kds_support_300);
        ...
        @Override public KSString getKSString() {
