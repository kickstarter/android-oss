...
public final class MessageHolderViewModelTest extends KSRobolectricTestCase {
  ...
  @Test
  public void testCreatorAvatarImage_SenderIsBacker() {
    final User recipient = UserFactory.user().toBuilder().name("Ima Creator").build();
    final User sender = UserFactory.user().toBuilder().name("Ima Backer").build();
  ...
  @Test
  public void testCreatorAvatarImage_SenderIsCreator() {
    final User recipient = UserFactory.user().toBuilder().name("Ima Backer").build();
    final User sender = UserFactory.user().toBuilder().name("Ima Creator").build();
