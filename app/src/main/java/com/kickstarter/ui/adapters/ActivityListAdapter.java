...
public class ActivityListAdapter extends RecyclerView.Adapter<ActivityListViewHolder> {
  ...
  public ActivityListViewHolder onCreateViewHolder(final ViewGroup viewGroup, final @ViewType int viewType) {
    final LayoutInflater layout_inflater = LayoutInflater.from(viewGroup.getContext());

    final View view;
    switch (viewType) {
      case FRIEND_BACKING:
        view = layout_inflater.inflate(R.layout.activity_friend_backing_view, viewGroup, false);
        return new FriendBackingViewHolder(view, presenter);
      case FRIEND_FOLLOW:
        view = layout_inflater.inflate(R.layout.activity_friend_follow_view, viewGroup, false);
        return new FriendFollowViewHolder(view, presenter);
      case PROJECT_STATE_CHANGED:
        view = layout_inflater.inflate(R.layout.activity_project_state_changed_view, viewGroup, false);
        return new ProjectStateChangedViewHolder(view, presenter);
      case PROJECT_STATE_CHANGED_POSITIVE:
        view = layout_inflater.inflate(R.layout.activity_project_state_changed_positive_view, viewGroup, false);
        return new ProjectStateChangedPositiveViewHolder(view, presenter);
      case PROJECT_UPDATE:
        view = layout_inflater.inflate(R.layout.activity_project_update_view, viewGroup, false);
