...
public class KSCurrencyTest extends TestCase {
  public void testFormatCurrency_withUserInUS() {
    ...
    assertEquals("$100", currency.formatCurrency(100.0f, ProjectFactory.project()));
    assertEquals("$100 CAD", currency.formatCurrency(100.0f, ProjectFactory.caProject()));
    assertEquals("£100", currency.formatCurrency(100.0f, ProjectFactory.ukProject()));
  }

  public void testFormatCurrency_withUserInCA() {
    final KSCurrency currency = createKSCurrency("CA");
    assertEquals("$100 USD", currency.formatCurrency(100.0f, ProjectFactory.project()));
    assertEquals("$100 CAD", currency.formatCurrency(100.0f, ProjectFactory.caProject()));
    assertEquals("£100", currency.formatCurrency(100.0f, ProjectFactory.ukProject()));
  }
  ...
  public void testFormatCurrency_withCurrencyCodeExcluded() {
    final KSCurrency currency = createKSCurrency("CA");
    assertEquals("$100", currency.formatCurrency(100.0f, ProjectFactory.project(), true));
  }

  public void testFormatCurrency_withUserInUSAndUSDPreferred() {
    final KSCurrency currency = createKSCurrency("US");
    assertEquals("$150", currency.formatCurrency(100.0f, ProjectFactory.ukProject(), false, true));
  }

  public void testFormatCurrency_withUserInUKAndUSDPreferred() {
    final KSCurrency currency = createKSCurrency("UK");
    assertEquals("£100", currency.formatCurrency(100.0f, ProjectFactory.ukProject(), false, true));
  }
}
