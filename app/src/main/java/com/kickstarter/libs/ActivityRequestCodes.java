...
public class ActivityRequestCodes {
  /*
   * Still figuring out how these codes should work - I think the code should identify
   * the requesting activity, the responding activity, and the reason for the request.
   */
