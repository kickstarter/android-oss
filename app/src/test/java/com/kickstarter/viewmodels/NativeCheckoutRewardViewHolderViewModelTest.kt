...
class NativeCheckoutRewardViewHolderViewModelTest : KSRobolectricTestCase() {
    ...
    fun testBackersCount_whenReward_withBackers() {
        ...
        val reward = RewardFactory.reward()
                ...
                .backersCount(30)
                .build()
        this.vm.inputs.configureWith(ProjectTrackingFactory.project(ProjectFactory.project()), reward)
    ...
    fun testBackersCount_whenNoReward() {
        ...
        this.vm.inputs.configureWith(ProjectTrackingFactory.project(ProjectFactory.project()), RewardFactory.noReward())
    ...
    fun testBackground_whenReward_goRewardlessDisabled() {
        ...
        this.vm.inputs.configureWith(ProjectTrackingFactory.project(ProjectFactory.project()), RewardFactory.reward())
    ...
    fun testButtonUIOutputs_whenProjectIsLiveAndUnbacked_soldOutReward() {
        ...
        this.vm.inputs.configureWith(ProjectTrackingFactory.project(ProjectFactory.project()), RewardFactory.limitReached())
        this.buttonIsGone.assertValue(false)
    ...
    fun testButtonUIOutputs_whenProjectIsLiveAndUnbacked_expiredReward() {
        ...
        this.vm.inputs.configureWith(ProjectTrackingFactory.project(ProjectFactory.project()), RewardFactory.ended())
        this.buttonIsGone.assertValue(false)
    ...
    fun testButtonUIOutputs_whenProjectIsLiveAndBacked_backedReward() {
        ...
        this.vm.inputs.configureWith(ProjectTrackingFactory.project(backedLiveProject), backedLiveProject.backing()?.reward()
    ...
    fun testButtonUIOutputs_whenProjectIsLiveAndBacked_availableReward() {
        ...
        this.vm.inputs.configureWith(ProjectTrackingFactory.project(ProjectFactory.backedProject()), RewardFactory.reward())
        this.buttonIsGone.assertValue(false)
        this.buttonCTA.assertValuesAndClear(R.string.Select)
    }
    ...
    fun testButtonUIOutputs_whenProjectIsLiveAndBacked_soldOutReward() {
        ...
        this.vm.inputs.configureWith(ProjectTrackingFactory.project(ProjectFactory.backedProject()), RewardFactory.limitReached())
        this.buttonIsGone.assertValue(false)
        this.buttonCTA.assertValue(R.string.No_longer_available)
    }
    ...
    fun testButtonUIOutputs_whenProjectIsLiveAndBacked_soldOutReward_andUnbacked() {
        ...
        this.vm.inputs.configureWith(ProjectTrackingFactory.project(ProjectFactory.backedProject()), RewardFactory.ended())
        this.buttonIsGone.assertValue(false)
        this.buttonCTA.assertValuesAndClear(R.string.No_longer_available)
    }
    ...
    fun testButtonUIOutputs_whenProjectIsEndedAndUnbacked_availableReward() {
        ...
        val successfulProject = ProjectFactory.successfulProject()
                ...
                .build()
        this.vm.inputs.configureWith(ProjectTrackingFactory.project(successfulProject), RewardFactory.reward())
    ...
    fun testButtonUIOutputs_whenProjectIsEndedAndBacked_availableReward() {
        ...
        val backedSuccessfulProject = ProjectFactory.backedProject()
                ...
                .state(Project.STATE_SUCCESSFUL)
                .build()
        this.vm.inputs.configureWith(ProjectTrackingFactory.project(backedSuccessfulProject), RewardFactory.reward())
        this.buttonIsGone.assertValue(true)
        this.buttonCTA.assertValuesAndClear(R.string.No_longer_available)
    }
    ...
    fun testButtonUIOutputs_whenProjectIsEndedAndBacked_noReward() {
        ...
        this.vm.inputs.configureWith(ProjectTrackingFactory.project(backedSuccessfulProject), RewardFactory.noReward())
        this.buttonIsGone.assertValue(true)
        this.buttonCTA.assertValuesAndClear(R.string.No_longer_available)
    }
    ...
    fun testButtonUIOutputs_whenProjectIsEndedAndBacked_backedReward() {
        ...
        this.vm.inputs.configureWith(ProjectTrackingFactory.project(backedSuccessfulProject), backedSuccessfulProject.backing()?.reward()
                ?: RewardFactory.reward())
        this.buttonIsGone.assertValue(false)
    ...
    fun testButtonUIOutputs_whenProjectIsEndedAndBacked_backedNoReward() {
        ...
        val backedNoRewardSuccessfulProject = ProjectFactory.backedProjectWithNoReward()
         ...
         this.vm.inputs.configureWith(ProjectTrackingFactory.project(backedNoRewardSuccessfulProject), RewardFactory.noReward())
        this.buttonIsGone.assertValue(false)
        this.buttonCTA.assertValue(R.string.Selected)
    }
    ...
    fun testButtonUIOutputs_whenProjectIsLive_availableReward_currentUserIsCreator() {
        ...
        this.vm.inputs.configureWith(ProjectTrackingFactory.project(project), RewardFactory.reward())
        this.buttonIsGone.assertValue(true)
        this.buttonCTA.assertValue(R.string.Select)
    }
    ...
    fun testButtonUIOutputs_whenProjectIsLive_noReward_currentUserIsCreator() {
        ...
        this.vm.inputs.configureWith(ProjectTrackingFactory.project(project), RewardFactory.noReward())
        this.buttonIsGone.assertValue(true)
        this.buttonCTA.assertValue(R.string.Select)
    }
    ...
    fun testConversion_USDProject_currentCurrencyUSD() {
        ...
        this.vm.inputs.configureWith(ProjectTrackingFactory.project(usProject), reward)
    ...
    fun testConversion_CADProject_currentCurrencyUSD() {
        ...
        this.vm.inputs.configureWith(ProjectTrackingFactory.project(caProject), reward)
    ...
    fun testDescriptionOutputs_whenReward_hasNoDescription() {
        ...
        this.vm.inputs.configureWith(ProjectTrackingFactory.project(ProjectFactory.project()), RewardFactory.noDescription())
    ...
    fun testDescriptionOutputs_whenBackedNoReward_goRewardlessDisabled() {
        ...
        val backedProject = ProjectFactory.backedProject()
                ...
                .build()
        this.vm.inputs.configureWith(ProjectTrackingFactory.project(backedProject), RewardFactory.noReward())
    ...
    fun testEndDateSectionIsGone() {
        ...
        this.vm.inputs.configureWith(ProjectTrackingFactory.project(project), expiredReward)
        this.endDateSectionIsGone.assertValue(true)
        ...
        this.vm.inputs.configureWith(ProjectTrackingFactory.project(project), expiringReward)
        this.endDateSectionIsGone.assertValues(true, false)

        this.vm.inputs.configureWith(ProjectTrackingFactory.project(ProjectFactory.successfulProject()), expiringReward)
    ...
    fun testShowPledgeFragment_WhenProjectIsSuccessful() {
        ...
        this.vm.inputs.configureWith(ProjectTrackingFactory.project(project), reward)
    ...
    fun testShowPledgeFragment_WhenProjectIsLiveNotBacked() {
        ...
        this.vm.inputs.configureWith(ProjectTrackingFactory.project(liveProject), reward)
        this.showPledgeFragment.assertNoValues()
    ...
    fun testShowPledgeFragment_WhenProjectIsLiveBacked() {
        ...
        this.vm.inputs.configureWith(ProjectTrackingFactory.project(backedProject), reward)
        this.showPledgeFragment.assertNoValues()
    ...
    fun testButtonIsEnabled() {
        ...
        this.vm.inputs.configureWith(ProjectTrackingFactory.project(ProjectFactory.successfulProject()), RewardFactory.reward())
    ...
    fun testLimitContainerIsGone_whenLimited() {
        ...
        this.vm.inputs.configureWith(ProjectTrackingFactory.project(project), RewardFactory.limited())
    ...
    fun testLimitContainerIsGone_whenEndingSoon() {
        ...
        this.vm.inputs.configureWith(ProjectTrackingFactory.project(project), RewardFactory.endingSoon())
        this.limitContainerIsGone.assertValue(false)
    }
    ...
    fun testLimitContainerIsGone_withShipping() {
        ...
        this.vm.inputs.configureWith(ProjectTrackingFactory.project(project), RewardFactory.rewardWithShipping())
        this.limitContainerIsGone.assertValue(false)
    }
    ...
    fun testRemaining() {
        ...
        this.vm.inputs.configureWith(ProjectTrackingFactory.project(project), RewardFactory.limitReached())
        this.remainingIsGone.assertValues(false, true)

        this.vm.inputs.configureWith(ProjectTrackingFactory.project(ProjectFactory.successfulProject()), RewardFactory.limitReached())
        this.remainingIsGone.assertValues(false, true)
    ...
    fun testRewardItems() {
        ...
        this.vm.inputs.configureWith(ProjectTrackingFactory.project(project), itemizedReward)
    ...
    fun testShippingSummary_whenRewardHasLimitedShipping() {
        ...
        this.vm.inputs.configureWith(ProjectTrackingFactory.project(project), rewardWithShipping)
    ...
    fun testTitleOutputs_whenReward_hasNoTitle() {
        ...
        val rewardWithNoTitle = RewardFactory.reward().toBuilder()
                .title(null)
                .build()
        this.vm.inputs.configureWith(ProjectTrackingFactory.project(ProjectFactory.project()), rewardWithNoTitle)
