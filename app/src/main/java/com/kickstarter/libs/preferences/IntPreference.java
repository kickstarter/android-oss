...
public class IntPreference {
  ...
  public IntPreference(final SharedPreferences sharedPreferences, final String key) {
    this(sharedPreferences, key, 0);
  }

  public IntPreference(final SharedPreferences sharedPreferences, final String key, final int defaultValue) {
