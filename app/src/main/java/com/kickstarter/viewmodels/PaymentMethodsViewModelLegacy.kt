...
interface PaymentMethodsViewModelLegacy {
    ...
    class ViewModel(environment: Environment) : ActivityViewModel<PaymentMethodsSettingsActivityLegacy>(environment), PaymentMethodsAdapter.Delegate, Inputs, Outputs {
